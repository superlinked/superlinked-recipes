# Ecommerce RecSys + NLQ Search

## Executive Summary

This project showcases an ecommerce session-based recommendation and NLQ (Natural Language Query) search system built using Superlinked.
We demonstrate how you can harness real-time user events, product content features, and your own collaborative data to build an advanced recommendation and search system for your site.
The system supports both user-to-item recommendations and item-to-item recommendations, as well as semantic NLQ-powered product search—taking into account product images, descriptions, popularity, price, item2vec representations, categories, types, and brands.
...
- **NLQ Search:** - Enables natural language product search, allowing users to find products using everyday language queries.
...
<div align="center">
  <img src="./assets/image.png" alt="System Architecture" width="50%">
</div>
