...
price_space = sl.NumberSpace(
    number=product_schema.price, mode=sl.Mode.MINIMUM, min_value=10, max_value=2000
)
...
brand_text_space = sl.TextSimilaritySpace(
    text=[product_schema.brand_text],
    model="sentence-transformers/paraphrase-MiniLM-L3-v2"
)
...
product_index = sl.Index(
    ...
    fields=[
        ...
        product_schema.category_level_1,
        user_schema.user_id
    ],
    temperature=0.8,
)
