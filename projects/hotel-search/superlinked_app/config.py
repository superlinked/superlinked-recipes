...
class Settings(BaseSettings):
    ...
    chunk_size: int = 1000
    path_categories: str = (
        "https://storage.googleapis.com/superlinked-recipes/hotels-search/categories.json"
    )
    path_dataset: str = (
        "https://storage.googleapis.com/superlinked-recipes/hotels-search/dataset.jsonl"
    )
